              ...
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                <form>
                  <div className="relative mb-6" data-te-input-wrapper-init>
                    ...
                    />
                    <label
                      className="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none "
                  ...
                  <button
                    type="button"
                    className="mb-6 w-full rounded bg-cyan-600 text-white px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal   lg:mb-0"
                  >
                    Send
                  </button>
                </form>
                ...
                <div className="flex flex-wrap">
                  <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                    <div className="flex items-start">
                      <div className="shrink-0">
                        <div className="inline-block rounded-md text-cayn-600 p-4 text-primary">
                          <svg
                      ...
                      <div className="ml-6 grow">
                        <p className="mb-2 font-medium">Technical support</p>
                        <p className="text-sm text-slate-950">
                          example@gmail.com
                        </p>
                        <p className="text-sm text-slate-950">1-600-890-4567</p>
                      </div>
                    </div>
                  </div>
                  <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                  ...
                  <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:mb-12 lg:w-full lg:px-6 xl:w-6/12">
                    <div className="align-start flex">
                      ...
                      <div className="ml-6 grow">
                        <p className="mb-2 font-medium">Land Line</p>
                        <p className="text-slate-950"> (0421) 431 2030</p>
                      </div>
                    </div>
                  </div>
                  <div className="w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:mb-12 xl:w-6/12">
                    <div className="align-start flex">
                      ...
                      <div className="ml-6 grow">
                        <p className="mb-2 font-medium">Mobile</p>
                        <p className="text-slate-950"> +91 123456789</p>
                      </div>
                    </div>
                  </div>
                </div>
