    ...
    <div className="w-full">
      <div className="w-full mx-auto">
        ...
        <div className="flex items-center justify-between relative">
          <p className="bg-blue-500  text-slate-50 py-1 px-2 rounded-full">
            Virtual Worlds
          </p>
          <div className="flex items-center gap-4 text-xl">
            <MdCloudUpload className="cursor-pointer" onClick={openSocial} />
            {social && (
              <div className="absolute top-20 left-2/3 bg-main-bg-color rounded-md p-4 bg-slate-50">
                <a
                  href="#"
                  className="flex items-center gap-2 text-icons-color hover:bg-blue-500  hover:text-slate-50 rounded-md p-2"
                >
            ...
            {NFTMenu && (
              <div className="absolute top-20 right-0 bg-main-bg-color rounded-md p-4 bg-slate-50 ">
                <a
                  href="#"
                  className="flex items-center gap-2 text-icons-color hover:bg-blue-500  hover:text-slate-50  rounded-md p-2"
                >
...
///// */}
        <div className="mt-6">
          ...
          <div className="flex items-center gap-8 py-6">
            ...
            <div className="flex items-center gap-4 border-l border-icons-color pl-8">
              <img
                src={images.user3}
                alt="user"
                className="rounded-full w-10 h-10"
          ...
          <div className="my-4">
            ...
            <div className="flex justify-between items-center mt-8">
              <div className="border-2 border-icons-color rounded-md p-4">
                <small className="bg-blue-500  text-slate-50 py-1 px-4 rounded-md text-sm">
                  Current Bid
                </small>
              ...
              {isCreatedByUser ? (
                ...
                <Link to={`/nft/${item.tokenId}/resaleform`}>
                  <Button
                    icon={<FaWallet />}
                    btnName="Resale NFT"
                    className="bg-main-bg-color text-icons-color py-2 px-4 rounded-full font-semibold"
                  />
                </Link>
              ) : (
